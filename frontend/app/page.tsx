    ...
    <main className="relative min-h-screen overflow-hidden bg-[var(--background)]">
      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        <header className="flex items-center justify-between px-6 py-6 md:px-10">
          <div className="font-mono text-sm tracking-[0.2em] text-[var(--muted)]">
            <span className="text-[var(--foreground)]">HEFIN</span> · Healthcare Intelligence
          </div>
          <div className="font-mono text-[10px] uppercase tracking-[0.18em] text-[var(--muted)]">AI Assistant</div>
        </header>
